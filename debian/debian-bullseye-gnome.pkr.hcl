...
build {
  ...
  provisioner "shell" {
    ...
    environment_vars  = [
      ...
      "PACKAGES=gnome__firefox-esr__chromium__epiphany-browser__neofetch__imwheel__gparted__celluloid__gnome-shell-extension-dash-to-panel__cups__dnsutils__virt-viewer__freerdp2-x11__docker.io__vim-gui-common",
      ...
      "BREWTAPS=hashicorp/tap__fluxcd/tap",
      "BREWFORMULAE=helm__kubernetes-cli__starship__minikube__terraform-docs__helm-docs__awscli__azure-cli__xorriso__hashicorp/tap/terraform__hashicorp/tap/packer__fluxcd/tap/flux",
      "GNOMESCALINGFACTOR=1.25",
    ]
    scripts = [
      "${path.root}/common/base.sh",
      "${path.root}/../common/reboot.sh",
      "${path.root}/../common/brew.sh",
