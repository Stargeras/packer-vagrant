...
build {
  ...
  provisioner "shell" {
    ...
    environment_vars = [
      ...
      "PACKAGES=gnome,firefox-esr,chromium,neofetch,imwheel,gparted,celluloid,gnome-shell-extension-dash-to-panel,cups,curl,vim,awscli,dnsutils,virt-viewer,freerdp2-x11,docker.io,vim-gui-common",
