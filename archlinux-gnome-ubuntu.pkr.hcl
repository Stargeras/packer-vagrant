...
build {
  ...
  provisioner "shell" {
    ...
    environment_vars  = [
      "username=vagrant",
      "PACKAGES=gnome__firefox__chromium__epiphany__neofetch__imwheel__gnome-tweaks__gparted__celluloid__cups__dnsutils__virt-viewer__freerdp__docker__code__ttf-droid__networkmanager__ttf-ubuntu-font-family__virtualbox-guest-utils__gedit__terraform__kubectl__helm__minikube__aws-cli",
