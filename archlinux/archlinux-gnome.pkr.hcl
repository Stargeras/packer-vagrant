...
build {
  ...
  provisioner "shell" {
    ...
    environment_vars  = [
      "username=vagrant",
      "PACKAGES=gnome__gnome-terminal__firefox__chromium__neofetch__imwheel__gnome-tweaks__gnome-connections__gparted__celluloid__cups__dnsutils__virt-viewer__freerdp__docker__ttf-droid__networkmanager__gedit__terraform__kubectl__helm__minikube__aws-cli",
