...
build {
  ...
  provisioner "shell" {
    ...
    environment_vars = [
      ...
      "PACKAGES=xdg-utils__chromium__firefox__gnome-shell-extension-dash-to-panel__gnome-backgrounds__neofetch__virt-viewer__freerdp__podman-docker__git__xorg-x11-fonts-75dpi__gnome-tweaks",
